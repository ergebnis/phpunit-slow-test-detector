...
$_SERVER['argv'][] = '--configuration=test/EndToEnd/Version07/Logger/WithConfigurationAndOption/phpunit.xml';
...
Runtime: %s
Configuration: %s/EndToEnd/Version07/Logger/WithConfigurationAndOption/phpunit.xml
